...
**Advanced Usage with External State Management:**

For integration with your auth system or custom state management, you can pass `chatState` and `chatDispatch` from `useChat()`:
...
- State persistence or custom middleware
